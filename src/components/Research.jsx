...
const Research = () => (
  <section id="research" className="mb-8 md:mb-12 scroll-mt-12">
    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between mb-4">
      <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-white">Research Paper Publications</h2>
    ...
    <div className="space-y-4">
      <a href="https://ieeexplore.ieee.org/author/659163992295229" target="_blank" rel="noopener noreferrer" className="group block border border-[var(--color-border-subtle)] rounded-[6px] p-4 sm:p-6 md:p-8 hover:border-[var(--color-brand-green)] transition-all duration-300 bg-gradient-to-r from-[var(--color-bg-surface)]/40 to-transparent">
        ...
        <h3 className="text-base sm:text-lg md:text-xl font-semibold text-white group-hover:text-[var(--color-brand-green)] transition-colors mb-2">Bridging Quantum and Classical AI: Cloud-Based Quantum Computing for Machine Learning</h3>
      ...
      <a href="https://ieeexplore.ieee.org/author/659163992295229" target="_blank" rel="noopener noreferrer" className="group block border border-[var(--color-border-subtle)] rounded-[6px] p-4 sm:p-6 md:p-8 hover:border-[var(--color-brand-green)] transition-all duration-300 bg-gradient-to-r from-[var(--color-bg-surface)]/40 to-transparent">
        ...
        <h3 className="text-base sm:text-lg md:text-xl font-semibold text-white group-hover:text-[var(--color-brand-green)] transition-colors mb-2">Scalable Intelligence: A Survey on Deploying AI Models in Distributed Cloud Platforms</h3>
        <p className="text-[var(--color-text-secondary)] text-sm leading-relaxed max-w-3xl">
      ...
      <a href="https://ieeexplore.ieee.org/author/659163992295229" target="_blank" rel="noopener noreferrer" className="group block border border-[var(--color-border-subtle)] rounded-[6px] p-4 sm:p-6 md:p-8 hover:border-[var(--color-brand-green)] transition-all duration-300">
        <div className="flex items-start justify-between gap-4 mb-3">
          <span className="text-[10px] uppercase font-medium tracking-wide text-[var(--color-text-secondary)]">IEEE AIBThings 2025</span>
          <ArrowUpRight size={16} className="text-[var(--color-text-secondary)] group-hover:text-[var(--color-brand-green)] transition-colors flex-shrink-0 opacity-0 group-hover:opacity-100" />
        </div>
        <h3 className="text-base sm:text-lg md:text-xl font-semibold text-white group-hover:text-[var(--color-brand-green)] transition-colors mb-2">SPX: A Novel LLM-Based Framework for Explaining and Estimating User Story Points</h3>
      ...
      <a href="https://ieeexplore.ieee.org/author/659163992295229" target="_blank" rel="noopener noreferrer" className="group block border border-[var(--color-border-subtle)] rounded-[6px] p-4 sm:p-6 md:p-8 hover:border-[var(--color-brand-green)] transition-all duration-300">
        ...
        <h3 className="text-base sm:text-lg md:text-xl font-semibold text-white group-hover:text-[var(--color-brand-green)] transition-colors mb-2">Integrating LLMs for Automated Bug Triaging and Root Cause Localization in Software Systems</h3>
        <p className="text-[var(--color-text-secondary)] text-sm leading-relaxed max-w-3xl mb-3">

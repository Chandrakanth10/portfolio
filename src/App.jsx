  ...
  return (
    <div className="min-h-screen text-[var(--color-text-primary)] font-sans selection:bg-[var(--color-brand-green)] selection:text-black">
      ...
      <main className="pt-32 pb-24">
        ...
        {/* Education */}
        <section id="education" className="max-w-6xl mx-auto px-6 mb-24">
          ...
          <div className="relative border-l border-[var(--color-border-subtle)] ml-3 md:ml-6 space-y-12">
            ...
            <div className="relative pl-10 md:pl-14">
              <div className="absolute -left-[24px] top-0 w-12 h-12 rounded-[6px] border border-[var(--color-border-subtle)] bg-[#1a1a1a] flex items-center justify-center z-10 shadow-lg group-hover:border-[var(--color-brand-green)] transition-colors">
                <GraduationCap className="w-6 h-6 text-[#8C1515]" />
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-1">
                <h3 className="text-xl font-semibold text-white">Master of Science, Computer Science</h3>
                <span className="text-sm font-mono text-[var(--color-text-secondary)]">2016 — 2018</span>
              </div>
              <div className="text-lg text-zinc-300 mb-2">Stanford University</div>
              <ul className="list-disc pl-5 space-y-1 text-[var(--color-text-secondary)] leading-relaxed max-w-3xl">
                <li>Specialization in Distributed Systems.</li>
                <li>Teaching Assistant for Database Internals.</li>
              </ul>
            </div>
            ...
            <div className="relative pl-10 md:pl-14">
              <div className="absolute -left-[24px] top-0 w-12 h-12 rounded-[6px] border border-[var(--color-border-subtle)] bg-[#1a1a1a] flex items-center justify-center z-10 shadow-lg group-hover:border-[var(--color-brand-green)] transition-colors">
                <GraduationCap className="w-6 h-6 text-[#FDB515]" />
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-1">
                <h3 className="text-xl font-semibold text-white">Bachelor of Science, Computer Science</h3>
                <span className="text-sm font-mono text-[var(--color-text-secondary)]">2012 — 2016</span>
              </div>
              <div className="text-lg text-zinc-300 mb-2">University of California, Berkeley</div>
              <ul className="list-disc pl-5 space-y-1 text-[var(--color-text-secondary)] leading-relaxed max-w-3xl">
                <li>Graduated Summa Cum Laude.</li>
                <li>President of the ACM Student Chapter.</li>
              </ul>
            </div>
          </div>
        </section>
